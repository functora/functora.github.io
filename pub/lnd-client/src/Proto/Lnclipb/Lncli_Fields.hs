...
module Proto.Lnclipb.Lncli_Fields where
...
lncli ::
  forall f s a.
  (Prelude.Functor f, Data.ProtoLens.Field.HasField s "lncli" a) =>
  Lens.Family2.LensLike' f s a
lncli = Data.ProtoLens.Field.field @"lncli"
lnd ::
  forall f s a.
  (Prelude.Functor f, Data.ProtoLens.Field.HasField s "lnd" a) =>
  Lens.Family2.LensLike' f s a
lnd = Data.ProtoLens.Field.field @"lnd"
maybe'lncli ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'lncli" a) =>
  Lens.Family2.LensLike' f s a
maybe'lncli = Data.ProtoLens.Field.field @"maybe'lncli"
maybe'lnd ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'lnd" a) =>
  Lens.Family2.LensLike' f s a
maybe'lnd = Data.ProtoLens.Field.field @"maybe'lnd"