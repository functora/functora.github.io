  ...
  testGroup
    ...
    [ testCase "date conversions" $ do
      ...
      testCase "Converting dates in the vicinity of 1900-03-01 to numbers" $ do
        ...
        dateToNumber DateBase1900 (UTCTime (fromGregorian 1900 2 28) 0)
          @?= (59 :: Double)
        dateToNumber DateBase1900 (UTCTime (fromGregorian 1900 3 1) 0)
          @?= (61 :: Double),
      testProperty "dateToNumber . dateFromNumber == id" $
        ...
        \b (n :: Pico) ->
          (n >= 60 && n < 61 && b == DateBase1900)
            || n == dateToNumber b (dateFromNumber b $ n),
      CellRefTests.tests
    ]
