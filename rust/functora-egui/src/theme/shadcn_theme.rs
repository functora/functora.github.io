...
pub struct ShadcnTheme {
    ...
    pub success_foreground: egui::Color32,
    pub warning: egui::Color32,
    pub warning_foreground: egui::Color32,
    pub info: egui::Color32,
    pub info_foreground: egui::Color32,
    pub chart_1: egui::Color32,
    pub chart_2: egui::Color32,
    pub chart_3: egui::Color32,
    pub chart_4: egui::Color32,
    pub chart_5: egui::Color32,
