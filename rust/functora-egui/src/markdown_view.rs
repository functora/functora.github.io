...
pub fn show(
    ...
    visuals.extreme_bg_color = theme.secondary;
    visuals.code_bg_color = theme.accent;
    visuals.faint_bg_color = theme.secondary;
    ...
    visuals.widgets.noninteractive.bg_fill = theme.secondary;
    visuals.widgets.active.bg_fill = theme.secondary;
    visuals.widgets.inactive.bg_fill = theme.secondary;
