let
  ...
  functora = fetchTarball {
    url = "https://github.com/functora/functora.github.io/archive/2ac970833a5b414974d5fedfa14643115d9c7be8.tar.gz";
    sha256 = "1skfrvyxn6qgljzzc36dqicjx6nxypbjpdrr67nk24a4mch5m0wb";
  };
