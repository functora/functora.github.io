//! Showcase app: an interactive catalog of every egui-shadcn widget,
...
pub struct ShowcaseApp {
    ...
    pub date_picker: egui_shadcn::DatePickerState,
...
impl ShowcaseApp {
    ...
    pub fn new(cc: &eframe::CreationContext<'_>) -> Self {
        ...
        Self {
            ...
            date_picker: egui_shadcn::DatePickerState::default(),
            color_swatch_idx: 0,
        ...
        if self.dialogs.dialog_open {
            ...
            Dialog::new()
                ...
                .show(ctx, &mut self.dialogs.dialog_open, |ui| {
                    ...
                    _ = ui.add(
                        egui_shadcn::Input::new(&mut self.form.form_name)
                            .placeholder("Ada Lovelace"),
                    );
                    ui.add_space(8.0);
                    _ = Label::new("Bio").show(ui);
                    _ = ui.add(
                        egui_shadcn::Textarea::new(&mut self.form.form_comments)
            ...
            Sheet::new()
                ...
                .show(ctx, &mut self.drawers.sheet_open, |ui| {
                    ...
                    for (label, desc) in [
                        ...
                        ("Update ready", "egui-shadcn 0.2 is available."),
                    ] {
