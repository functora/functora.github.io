let
  ...
  functora = fetchTarball {
    url = "https://github.com/functora/functora.github.io/archive/1b0b5fc6594df8e7002515f884d87abb1fdcd1c3.tar.gz";
    sha256 = "1nsyfd6cxpgw49bp50lhff5zix6x6nn77lwi19xnwwd92sbjd6v4";
  };
  legacy = fetchTarball {
