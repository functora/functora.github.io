...
#           -file ${../bak/doom/64/BD64-VoH_game_v1.6.1.pk3} \
#           -file ${../bak/doom/64/BD64-VoH_maps_v1.6.1.pk3} \
#           -file ${../bak/doom/64/BD64-VoH_MoreSFX.pk3} \
#           -file ${../bak/doom/64/BD64_HeavyBackpack.pk3} \
#           -file ${../bak/doom/64/BrutalDoom64_Metal_Veteran_Of_Hell_Edition.pk3} \
...
#           -file ${../bak/doom/AshesStandalone_V1_51/Resources/AshesAfterglow1_16.pk3} \
#           -file ${../bak/doom/AshesSmooth/ashesafterglow-smooth-enemies.pk3} \
#           -file ${../bak/doom/AshesVoxelPickups-Ep2.pk3} \
