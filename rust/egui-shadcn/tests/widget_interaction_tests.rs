...
fn resizable_handle_drag_changes_fraction() {
    ...
    let mut body = |ui: &mut egui::Ui| {
        egui_shadcn::Resizable::new().height(240.0).show(
            ui,
            &mut fraction,
            |ui| {
                ui.label("L");
...
fn resizable_inside_demo_shell_has_full_width() {
    ...
    let mut body = |ui: &mut egui::Ui| {
        let spacing = egui_shadcn::ResponsiveExt::responsive_spacing(ui);
            ...
            .show(ui, |ui| {
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.vertical(|ui| {
                        ...
                        egui_shadcn::Typography::muted("Draggable split pane.").show(ui);
                        ui.add_space(12.0);
                        egui_shadcn::Resizable::new().height(160.0).show(
                            ui,
                            &mut fraction,
                            |ui| {
                                ui.label("L");
...
fn command_palette_list_scrolls_when_overflowing() {
    ...
    let mut body = |ui: &mut egui::Ui| {
        egui_shadcn::Command::new(items.clone()).show(ui.ctx(), &mut open, &mut search);
    };
...
fn scroll_area_wheel_scrolls_content() {
    let mut body = |ui: &mut egui::Ui| {
        egui_shadcn::ScrollArea::new(200.0).show(ui, |ui| {
            let (rect, _) = ui
