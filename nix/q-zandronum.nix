...
in
  stdenv.mkDerivation rec {
    ...
    src = fetchurl {
      url = "https://github.com/IgeNiaI/Q-Zandronum/releases/download/${version}/Q-Zandronum_${version}_Linux_amd64.tar.gz";
      hash = "sha256-RwxBvGAivY7Ecd5xsVuUWJBoq93U5CdpBsJB2gjgV6k=";
    };
