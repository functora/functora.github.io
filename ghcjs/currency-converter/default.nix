let
  ...
  functora = fetchTarball {
    url = "https://github.com/functora/functora.github.io/archive/1ffd6ec3f911d0413f61c1b508940aba932f48bd.tar.gz";
    sha256 = "1gk71dlzmz1idrpf2zvd4wpgbd9n6in1mclvwgypr224brvmppb3";
  };
