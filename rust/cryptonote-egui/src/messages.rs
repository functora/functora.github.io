...
impl I18N for Msg {
    fn render_eng(&self) -> String {
        match self {
            ...
            Self::Note => "Note".into(),
            Self::NotePlaceholder => "Enter your note here (Markdown/HTML supported)...".into(),
            Self::Mode => "Mode".into(),
            ...
            Self::ShareAppDesc => {
                "Cryptonote is a cross-platform, serverless app for encrypted offline notes. Try it:".into()
            }
            Self::EncryptedNote => "Encrypted".into(),
            Self::EncryptedNoteDesc => {
...
Secure, private, and truly offline - your notes remain yours alone.".into(),
            ...
            Self::ArchiveReady => {
                "Cryptonote archive ready. Press Download to save and share with your recipient.".into()
            }
    ...
    fn render_spa(&self) -> String {
        match self {
            ...
            Self::Note => "Nota".into(),
            Self::NotePlaceholder => {
                "Escribe tu nota aquí (Markdown/HTML soportado)...".into()
            }
            Self::Mode => "Modo".into(),
            ...
            Self::ShareAppDesc => {
                "Cryptonote es una aplicación multiplataforma y sin servidores para notas cifradas sin conexión. Pruébala:".into()
            }
...
Seguro, privado y verdaderamente offline - sus notas siguen siendo solo suyas.".into(),
            ...
            Self::ArchiveReady => {
                "Archivo Cryptonote listo. Presiona Descargar para guardar y compartir con tu destinatario.".into()
            }
            ...
            Self::PreviewUnavailable => {
                "La vista previa no está disponible para este tipo de archivo".into()
            }
    ...
    fn render_rus(&self) -> String {
        match self {
            ...
            Self::NotePlaceholder => {
                "Введите вашу заметку здесь (Markdown/HTML поддерживается)...".into()
            }
            ...
            Self::ShareAppDesc => {
                "Cryptonote - кроссплатформенное бессерверное приложение для зашифрованных офлайн-заметок. Попробуйте:".into()
            }
...
Безопасно, приватно и по-настоящему автономно - ваши заметки остаются только вашими.".into(),
            ...
            Self::ArchiveReady => {
                "Архив Cryptonote готов. Нажмите Скачать, чтобы сохранить и поделиться с получателем.".into()
            }
            ...
            Self::File => "Файл".into(),
            Self::PreviewUnavailable => {
                "Предварительный просмотр недоступен для этого типа файлов".into()
            }
