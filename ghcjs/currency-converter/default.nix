let
  ...
  functora = fetchTarball {
    url = "https://github.com/functora/functora.github.io/archive/f876640d7a9db01082f685cbe8140ca225aec9eb.tar.gz";
    sha256 = "0vkxng76x5z35m45c3vl04zc58li4s0frqpcln8f31mj3wkrjydw";
  };
